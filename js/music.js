const previousSong = document.querySelector("#previousBtn");
const nextSong = document.querySelector("#nextSong");
const btnPlay = document.querySelector("#btnPlay");
let audioArr = [
  "./audio/Cordae_Dream in Color.mp3",
  "./audio/Frank Ocean_In My Room.mp3",
  "./audio/Frank Ocean_Self Control.mp3",
  "./audio/joji_EW.mp3",
];
// Audio 객체 설정
